...
| -------------------------- | ---------------------: | --------------------------------: |
| Differential state `x(t)`  |        usually unfixed |        fixed or constrained by IC |
| Derivative `dx/dt` or `x'(t)` |             unfixed |                   usually unfixed |
| Algebraic variable `z(t)`  |        usually unfixed | determined by algebraic equations |
| Algebraic parameter `u(t)` | fixed or parameterized |            fixed or parameterized |
